...
const coordinator = (() => {
  ...
  const loadHomePageWithLocalStorage = () => {
    const allItems = _localStorageController__WEBPACK_IMPORTED_MODULE_5__.default.getItems();
    _dataController__WEBPACK_IMPORTED_MODULE_2__.default.setStoredItems(allItems);
  ...
  const updateLocalStorage = () => {
    const itemsArray = _dataController__WEBPACK_IMPORTED_MODULE_2__.default.getItemsFromTab('All items');
    _localStorageController__WEBPACK_IMPORTED_MODULE_5__.default.update(itemsArray);
  };
