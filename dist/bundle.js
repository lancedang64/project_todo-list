...
/* harmony import */ var _localStorageController__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./localStorageController */ "./src/modules/localStorageController.js");
...
const coordinator = (() => {
  ...
  const loadHomePageWithLocalStorage = () => {
    const items = _localStorageController__WEBPACK_IMPORTED_MODULE_5__.default.getData('items');
    const projects = _localStorageController__WEBPACK_IMPORTED_MODULE_5__.default.getData('projects');
    _dataController__WEBPACK_IMPORTED_MODULE_2__.default.setStoredData(items, projects);
    _domController__WEBPACK_IMPORTED_MODULE_0__.default.renderItemsFromArray(items);
    _domController__WEBPACK_IMPORTED_MODULE_0__.default.renderProjectsFromArray(projects);
  };
  ...
  const loadHomePageWithExamples = () => {
    ...
    const projects = _dataController__WEBPACK_IMPORTED_MODULE_2__.default.getProjects();
    _domController__WEBPACK_IMPORTED_MODULE_0__.default.renderProjectsFromArray(projects);
    _domController__WEBPACK_IMPORTED_MODULE_0__.default.renderItemsFromArray(allItems);
  };
  ...
  const updateLocalStorage = () => {
    const items = _dataController__WEBPACK_IMPORTED_MODULE_2__.default.getItemsFromTab('All items');
    const projects = _dataController__WEBPACK_IMPORTED_MODULE_2__.default.getProjects();
    _localStorageController__WEBPACK_IMPORTED_MODULE_5__.default.updateData('items', items);
    _localStorageController__WEBPACK_IMPORTED_MODULE_5__.default.updateData('projects', projects);
  };
  ...
  const promptNewProject = (e) => {
    sweetalert__WEBPACK_IMPORTED_MODULE_3___default()('Please enter your new project name:', {
      ...
      _dataController__WEBPACK_IMPORTED_MODULE_2__.default.addProject(value);
  ...
  const deleteProject = (e) => {
    ...
    _domController__WEBPACK_IMPORTED_MODULE_0__.default.removeProject(tabName);
    _dataController__WEBPACK_IMPORTED_MODULE_2__.default.removeProject(tabName);
    updateLocalStorage();
  };
